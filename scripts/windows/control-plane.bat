...
findstr /B /C:"WEBAPP_WORKERS=" .env >nul 2>&1 || echo WEBAPP_WORKERS=1>>.env
findstr /B /C:"HEARTHLIGHT_AUTO_START_ON_SOURCE_SAVE=" .env >nul 2>&1 || echo HEARTHLIGHT_AUTO_START_ON_SOURCE_SAVE=true>>.env
